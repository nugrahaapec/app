                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <form action="<?= site_url('Cancel/') . $data['code_permintaan'] ?>" method="post">
                                                            <?= csrf_field() ?>
                                                            <td style="text-align: center;">
                                                                <?php if ($data['status'] == 1) {
                                                                    echo "<button type='submit'class='btn btn-danger btn-sm mr-1'><i class='fas fa-ban'></i></button>";
                                                                    echo "<a href='" . site_url('ProsesPermintaan/') . $data['code_permintaan'] . "' class='btn btn-info btn-sm mr-1'><i class='fas fa-sync'></i></a>";
                                                                }
                                                                if ($data['status'] == 2) {
