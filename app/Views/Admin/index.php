    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Storeboard</h3>
                        ...
                        <div class="table-responsive p-0">
                            <table class="table table-bordered table-sm">
                                ...
                                <tbody>
                                    ...
                                    $query = mysqli_query($conn, "SELECT * FROM data_aset  ORDER BY kategori");
                                    $arr = array();
