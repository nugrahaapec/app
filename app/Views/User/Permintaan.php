        ...
        <div class="col-sm-12">
            <div class="content">
                ...
                <div class="card card-outline card-warning">
                    <form action="<?= site_url('PermintaanPerangkat') ?>" method="GET" accept-charset="utf-8">
                ...
                ?>
                    <form action="<?= site_url('SavePermintaan') ?>" class="form-horizontal" method="POST">
                        <?= csrf_field() ?>
                        <?php
                        ...
                        <div class="card card-outline card-warning">
                            <div class="card-header">
                                <label>Permintaan Perangkat Untuk Store HokBen <?= ucwords($hasil['nama_store']) ?></label>
